    ...
    <div class="col-lg-12 d-flex align-items-stretch">
      <div class="card w-100">
        <div class="card-body p-4">
          <h5 class="card-title fw-semibold mb-4 al">Student List</h5>
            ...
            <table class="table text-nowrap mb-0 align-middle">
              <thead class="text-dark fs-4">
                <tr>
                  ...
                  <th class="border-bottom-0">
                    <h6 class="fw-semibold mb-0">University Id</h6>
                  </th>
                  <th class="border-bottom-0">
...
while ($display = mysqli_fetch_array($res)) 
{
 ?>  
  <td><?php echo $s++?></td>
                        <td><?php echo $display["universityid"]?></td>
                        <td><?php echo $display["studentname"]?></td>
                        <td><?php echo $display["parentemail"]?></td>
