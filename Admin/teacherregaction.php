...
if(isset($_POST["save"]))
{
    ...
    if($rows> 0)
    {
        ...
        window.location='teacherreg.php'</script>";
    }
    else
    {
      echo  $sql="INSERT INTO tblteacher(teachername,teacheremail,teacherphone,teacherusername,teacherpassword,teacherrole,departmentid) VALUES ('$tname','$email','$phone','$username','$password','$role','$did')";
        $res=$obj->executequery($sql);
        if($res==1)
        {
