...
$sql = "SELECT 
            ...
            tc.teacherusername,
            tc.teacherpassword,
            tc.teacherrole,tc.departmentid,
            tp.departmentname
                ...
                <tr>
                    ...
                    <td class="border-bottom-0">
                        <a class="viewlog-link"
                            href="sem_report.php?id=<?php echo $display['teacherid']; ?>&did=<?php echo $display['departmentid']; ?>&token=<?php echo $unique_token; ?>">viewlog</a>
